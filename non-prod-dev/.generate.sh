...
OCP_PROJECT=dev  													# Project to be created in Openshift
OCP_PROJECT_NAMESPACE=$OCP_PROJECT 									# Project Namespace - typically like the OCP_PROJECT
DOCKER_OAUTH=<SERVICE_ACCOUNT>@<PROJECT>.iam.gserviceaccount.com 	# PUSH access service account email, provide to EQ dev to build the ETL
